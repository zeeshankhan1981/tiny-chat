...
actor LlavaContext {
    ...
    static func create_context(model_path: String, mmproj_path: String) throws -> LlavaContext {
        let llava_cli_context = llamaforked.llava_init(mmproj_path, model_path, "", 0)
    ...
    func set_image(base64: String) {
        ...
        llamaforked.load_image(mmproj_path, context, img_prompt)
    }
    ...
    /// ✅ Call this manually when the actor is no longer needed
    func shutdown() {
